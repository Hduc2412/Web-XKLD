    ...
    <>
      ...
      <Section>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_1fr]">
          ...
          <Card className="h-fit border-dashed p-6">
            <h2 className="text-base font-bold text-slate-900">
              Phần nhập hồ sơ đang được hoàn thiện
            </h2>
            <div className="mt-3 space-y-3 text-sm leading-6 text-slate-600">
              <p>
                Bộ đối chiếu và biểu mẫu nhập hồ sơ là hạng mục đang làm. Trong
                lúc chờ, bạn có ba cách để bắt đầu ngay.
              </p>
            </div>

            <div className="mt-6 space-y-3">
              <Button href="/don-hang" className="w-full">
                Xem danh sách đơn hàng đang tuyển
              </Button>
              <Button href="/dieu-kien" variant="outline" className="w-full">
                Đọc điều kiện tham gia
              </Button>
              <Button href={COMPANY.hotlineHref} variant="outline" className="w-full">
                Gọi {COMPANY.hotline}
              </Button>
            </div>
